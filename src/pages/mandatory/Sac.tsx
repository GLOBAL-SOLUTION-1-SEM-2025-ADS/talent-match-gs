...
const Sac = ({ buttonText }: Props) => {
  ...
  return (
    <section className="px-4 md:px-10 py-16 bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="max-w-5xl mx-auto bg-white border border-blue-100 shadow-2xl rounded-3xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit(enviarFormulario)} className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  {...register("name")}
                  className={`w-full rounded-xl border p-3.5 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 transition ${
                    errors.name
