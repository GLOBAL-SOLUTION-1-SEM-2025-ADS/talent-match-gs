    ...
    return (
      <section className="px-4 md:px-10 py-16 
        ...
        <div className="max-w-xl mx-auto space-y-4">
          <p className="text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-800 rounded-lg px-4 py-3">
            Nenhuma vaga foi informada. Volte e preencha a descrição da vaga antes de enviar um currículo.
          </p>
          <Link
            to="/vaga"
            className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg text-sm font-semibold shadow-md"
          >
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-wide text-blue-700 dark:text-indigo-300">
                Passo 2 de 2
              </p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-5">
            <div className="bg-white dark:bg-gray-900 border border-blue-100 dark:border-gray-700 rounded-2xl shadow-md p-5">
              <p className="text-xs font-semibold text-blue-700 dark:text-indigo-300 uppercase tracking-wide">
                Vaga selecionada
              </p>
            ...
            <div className="bg-white dark:bg-gray-900 border border-blue-100 dark:border-gray-700 rounded-3xl shadow-lg p-4 md:p-6">
              <UploadCard onUpload={enviarArquivo} />
              {status && <LoadingStatus mensagem={status} />}
              {erro && (
                <p className="mt-4 text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-800 rounded-lg px-4 py-3">
                  {erro}
                </p>
              )}
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-900 border border-blue-100 dark:border-gray-700 rounded-2xl shadow-md p-6">
              <p className="text-sm font-semibold text-blue-900 dark:text-indigo-300">
